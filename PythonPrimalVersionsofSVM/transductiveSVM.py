...
testdataAll = np.concatenate((testdata1, testdata2), axis=0)
...
plt.savefig('transductiveSVM_train_decision.png')
...
plt.savefig('transductiveSVM_test_decision.png')
plt.show()
